...
interface AutoCompoundingDialogProps {
  currentAllocation: PortfolioAllocation;
  isEnabled?: boolean;
}

export default function AutoCompoundingDialog({ 
  currentAllocation,
  isEnabled = true 
}: AutoCompoundingDialogProps) {
        ...
        <div className="space-y-6">
          ...
          <Alert className="bg-purple-900/20 border-purple-900/50">
            ...
            <AlertDescription className="text-purple-400">
              Coming Soon! Automatisches Reinvestieren Ihrer Staking Rewards für nur $1/Monat.
            </AlertDescription>
          </Alert>
